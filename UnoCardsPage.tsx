  ...
  const cards: UnoCardData[] = [
    {
      ...
      number: "1",
      photoUrl: Img1,
      caption: "This is how i imagine you when you happy because food is all you love",
    ...
    },
    {
      ...
      number: "2",
      photoUrl: Img2,
      caption: "This is how i imagine you when you are angry and want to kill me",
      musicName: "Bulleya",
      musicUrl: Music2,
    },
    {
      ...
      number: "3",
      photoUrl: Img3,
      caption: "This is how i imagine you when the kid inside you want to be mischief",
      musicName: "Perfect",
      musicUrl: Music3,
    },
    {
      ...
      number: "4",
      photoUrl: Img4,
      caption: "This is how i imagine you when you are most cutest",
      musicName: "O Rangrez",
      musicUrl: Music4,
    },
    ...
    >
      ...
      {flipped.every((isFlipped) => isFlipped) && (
        <div className="text-center transition-all duration-500">
          ...
          >
            Well, I have written something for you Madam<ChevronRight className="ml-2" />
          </button>
        </div>
      )}
    </div>
